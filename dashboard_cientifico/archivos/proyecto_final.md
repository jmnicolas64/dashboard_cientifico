...
En la versión **Básica** se muestra estrictamente lo que pide el ejercicio. El archivo JSON se genera automáticamente cuando carga inicialmente los datos y queda disponible en la carpeta 'descargas'. La fuente de datos es la db para compatibilizar las 2 versiones.
